...
$l['act_max_interval_in_mins_desc' ] = 'Active thread queries over a large interval can be expensive. Set here, in minutes, the maximum permissible interval that users may enter. For reference: 1,440 minutes = a day; 10,080 minutes = a week; 20,160 minutes = a fortnight. Set to zero for unlimited intervals.';
